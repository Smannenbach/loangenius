...
const DEAL_STAGE_CONFIG = {
  ...
  lead: { label: 'Lead', color: 'bg-gray-100 text-gray-700', icon: Circle },
  ...
  conditional_approval: { label: 'Conditional', color: 'bg-purple-100 text-purple-700', icon: CheckCircle },
  approved: { label: 'Approved', color: 'bg-orange-100 text-orange-700', icon: CheckCircle },
  clear_to_close: { label: 'Clear to Close', color: 'bg-cyan-100 text-cyan-700', icon: CheckCircle },
